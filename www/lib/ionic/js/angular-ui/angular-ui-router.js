...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory) {
   ...
   * Examples:
   *
   * Targets three named `ui-views`s in the parent state's template
   * <pre>views: {
   *     header: {
   ...
   *   }</pre>
   *
   * Targets named `ui-views="header"` from grandparent state 'top''s template, and named `ui-views="body" from parent state's template.
   * <pre>views: {
   *     'header@top': {
 ...
 *
 * @description
 * The ui-views directive tells $state where to place your templates.
 *
...
/**
 * Shared ui-views code for both directives:
 * Given scope, element, and its attributes, return the views's name
 */
